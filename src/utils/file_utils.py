...
class FileManager:
    ...
    def get_file_hash(self, path: Union[str, Path], algorithm: str = "md5") -> Optional[str]:
        """Calculate file hash."""
        path = Path(path)
    ...
    def backup_directory(self, source: Union[str, Path], 
    ...
    def convert_image_format(self, src: Union[str, Path], 
                           dst: Union[str, Path],
                           format: str = "PNG",
                           quality: int = 95) -> bool:
