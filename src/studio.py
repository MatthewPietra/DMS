...
class DMS:
    ...
    def _initialize_components(self):
        ...
        try:
            ...
            self.logger.info(f"Hardware detected: {self.hardware_detector.get_device_type()}")
            
            # Capture system
            capture_config = CaptureConfig()
            self.capture_system = WindowCaptureSystem(capture_config, self.hardware_detector)
    ...
    def start_capture(self, duration: Optional[int] = None, 
                     output_dir: str = "data/captured") -> Dict[str, Any]:
        """
    ...
    def train_model(self, data_path: str, model_name: str = "yolov8n", 
    ...
    def auto_annotate(self, data_path: str, model_path: str, 
                     output_path: str = "data/auto_annotated") -> Dict[str, Any]:
        """
        ...
        if image_path.is_file():
            ...
            image_files = [str(f) for f in image_path.glob("*.jpg") + image_path.glob("*.png")]
    ...
    def export_dataset(self, data_path: str, output_path: str, 
    ...
    def get_project_status(self) -> Dict[str, Any]:
        ...
        # Count files
        image_count = len(list((project_path / "images").glob("*.jpg")) + 
