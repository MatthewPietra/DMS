...
class ConfidenceManager:
    ...
    def filter_annotations_by_confidence(self, 
    ...
    def get_confidence_statistics(self, annotations: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "review_count": sum(1 for c in confidences if self.reject_threshold < c < self.accept_threshold),
