...
class AuthenticationManager:
    ...
    def _get_default_config_path(self) -> str:
        ...
        return str(Path(__file__).parent.parent.parent / "config" / "keyauth_config.json")
    ...
    def save_session_to_file(self, session_file: str = None) -> bool:
        ...
        try:
            if session_file is None:
                session_file = str(Path(__file__).parent.parent.parent / "data" / "current_session.json")
    ...
    def get_authentication_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'keyauth_status': self.check_keyauth_expiry() if self.current_user else None
        } 