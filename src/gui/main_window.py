...
try:
    ...
    try:
        ...
        try:
            ...
            raise ImportError("No compatible GUI framework found. Please install PySide6, PyQt6, or PyQt5.")
...
class DMSMainWindow(QMainWindow):
    ...
    def setup_toolbar(self):
        ...
        # New project
        if ICONS_AVAILABLE:
            new_project_action = QAction(IconManager.get_icon("new"), "New Project", self)
        else:
            new_project_action = QAction("New Project", self)
        new_project_action.triggered.connect(self.new_project)
        ...
        # Open project
        if ICONS_AVAILABLE:
            open_project_action = QAction(IconManager.get_icon("open"), "Open Project", self)
        else:
            open_project_action = QAction("Open Project", self)
        open_project_action.triggered.connect(self.open_project)
    ...
    def update_system_info(self):
        ...
        try:
            ...
            self.memory_info_label.setText(f"Memory: {memory_percent:.1f}% ({memory_gb:.1f}GB)")
