...
class DashboardWidget(QWidget):
    ...
    def create_quick_actions(self, layout):
        ...
        group_box.setStyleSheet("QGroupBox::title { color: #2196F3; font-size: 15px; font-weight: bold; subcontrol-origin: margin; subcontrol-position: top center; }")
        ...
        # Action buttons
        actions = [
            ("New Project", "new", "Create a new object detection project", 
             lambda: self.main_window.show_page("projects")),
            ("Screen Capture", "camera", "Start capturing screen data", 
             lambda: self.main_window.show_page("capture")),
            ("Annotate Data", "edit", "Open annotation interface", 
             lambda: self.main_window.show_page("annotation")),
            ("Train Model", "brain", "Start model training", 
             lambda: self.main_window.show_page("training")),
            ("System Monitor", "monitor", "View system resources", 
