#!/bin/bash
# DMS GUI Launcher - Unix/Linux Shell Script
# This script creates a dedicated Python 3.10 virtual environment and launches DMS GUI
...
if [ ! -f "gui_launcher.py" ]; then
    echo -e "${RED}ERROR: gui_launcher.py not found in current directory${NC}"
...
# Launch the GUI studio using dedicated virtual environment
echo
echo -e "${BLUE}Launching DMS GUI with dedicated virtual environment...${NC}"
...
echo
echo -e "${GREEN}DMS GUI session completed${NC}" 