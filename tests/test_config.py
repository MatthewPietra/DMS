...
from yolo_vision_studio.config import (
    YOLOVisionConfig, HardwareConfig, CaptureConfig, 
    TrainingConfig, AnnotationConfig, ProjectConfig
)
...
class TestConfigurationClasses(unittest.TestCase):
    ...
    def test_training_config(self):
        ...
        self.assertIn(config.model, ["yolov8n", "yolov8s", "yolov8m", "yolov8l", "yolov8x"])
