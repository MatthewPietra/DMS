...
from yolo_vision_studio.annotation.coco_exporter import COCOExporter
    ...
    def test_yolo_format_export(self):
        ...
        for image_name in self.sample_annotations.keys():
            ...
            for line in lines:
                ...
                self.assertEqual(len(parts), 5)  # class_id, center_x, center_y, width, height
